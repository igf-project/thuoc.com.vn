...
<div class='mess'>
	Đặt hàng ngay hôm nay để cùng nhau sở hữu sản phẩm rẻ nhất tại hangvietgiatot.com
</div>
...
?>
	...
	<fieldset>
		...
		<table width="100%">
			<tr>
				<td align='right' width=150>Họ Và Tên<span class='star'>*</span>:</td>
				<td><input type='text' name='txt_name' id='txt_name'/> Họ tên đầy đủ của bạn</td>
			</tr>
			<tr>
				<td align='right'>Số Điện Thoại<span class='star'>*</span>:</td>
				<td><input type='text' name='txt_tel' id='txt_tel'/> Số điện thoại chính xác để chúng tôi xác nhận</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type='text' name='sercury_code' id="sercury_code" style="float:left;margin-right:5px;" /> <img style="float:left;margin-right:5px;" height='21' src='<?php echo ROOTHOST;?>/extensions/captcha/CaptchaSecurityImages.php' alt='sercury code hangvietgiatot.com' /></td>
			</tr>
		</table>
	</fieldset>
	<fieldset>
		<legend>Hình thức nhận hàng</legend>
		<h4>1. <label><input type='radio' name='opt_ship' id='opt_ship1' value='Giao hàng tận nơi'/>Giao hàng tận nơi</label></h4>
		...
		<h4>2. <label><input type='radio' checked='true' name='opt_ship' id='opt_ship2' value='Nhận hàng tận văn phòng '/>Nhận hàng tận văn phòng của hangvietgiatot.com</label></h4>
	...
	<fieldset>
		...
		<table width="100%">
			<tr>
				<td><label><input type='radio' checked='true'  name='opt_payment' id='opt_payment' value='Giao hàng và thu tiền tận nơi'/> Giao hàng và thu tiền tại nơi!</label></td>
			</tr>
			<tr>
				<td>
				<label><input type='radio' name='opt_payment' id='opt_payment' value='Chuyển khoản'/> Chuyển khoản (Quý khách vui lòng điền mã đơn hàng để hangvietgiatot.com kiểm tra nhanh hơn)</label>
