...
class CLS_RECRUITMENT{
    ...
    public function Add_new(){
        $sql="INSERT INTO `tbl_recruitment` (`cate_id`, `showroom_id`, `code`, `title`, `intro`, `fulltext`, `edate`, `cdate`, `mdate`, `meta_title`, `meta_key`, `meta_desc`, `isactive`) VALUES ";
        $sql.="('".$this->Cate_ID."','".$this->Showroom_ID."','".$this->Code."','".$this->Title."','".$this->Intro."','".$this->Fulltext."','".$this->Edate."','";
