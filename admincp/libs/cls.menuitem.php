...
class CLS_MENUITEM{
	...
	function listTableItemMenu($strwhere="",$page,$par_id,$level){
		...
		public function Add_new(){
			$sql="INSERT INTO `tbl_mnuitem`(`par_id`,`code`,`mnu_id`,`viewtype`,`cat_id`,`con_id`,`link`,`class`,`thumb`,`isactive`) VALUES ";
			$sql.=" ('".$this->Par_ID."','".$this->Code."','".$this->Mnu_ID."','".$this->Viewtype."','".$this->Cat_ID."','".$this->Con_ID."','".$this->Link."','".$this->Class."','".$this->Thumb."','".$this->isActive."') ";
			// echo $sql; die();
