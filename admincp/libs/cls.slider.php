...
class CLS_SLIDER{
	...
	public function listTable($strwhere="",$page){
		...
		{	$i++;
			...
			echo "</label></td>";
			echo "<td title=''><img src='$img' class='img-obj' width='120px'> </td>";
	...
	public function Add_new(){
		$sql="INSERT INTO `tbl_slider` ( `slogan`, `intro`, `type`,`link`, `isactive`) VALUES ";
		$sql.="('".$this->Slogan."','".$this->Intro."','".$this->Type."','".$this->Link."','".$this->isActive."')";
