                    ...
                    <div class="col-md-6">
                        <div class='form-group row'>
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <input name="txtthumb" type="text" id="file-thumb" size="45" class='form-control' value="<?php echo $row['thumb'];?>" placeholder='Chọn đường dẫn ảnh' />
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="box-select" style="margin-bottom: 12px; margin-left: 10px">
                                ...
                                <select id="cbo_location" class="cbo_location" name="arrFood[]" multiple="multiple">
                                    <?php
                                    $food_id='';
                                    if(count($row['food_id'])> 0){
                                        $food_id= explode(',', $row['food_id']);
                                    }
                                    include_once(LIB_PATH.'cls.food.php');
                                    if(!isset($objfood)) $objfood=new CLS_FOOD();
                                    echo $objfood->getListCbItem('','',$food_id);
                                    ?>
                                </select>
                                <script>
