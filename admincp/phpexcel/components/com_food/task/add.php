        ...
        function checkinput(){
            if($("#txt_name").val()==""){
                $("#txt_name_err").fadeTo(200,0.1,function(){
                    $(this).html('Vui lòng nhập thực đơn').fadeTo(900,1);
                });
                $("#txt_name").focus();
                return false;
            }
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="info">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txt_price" class="form-control" id="txt_price" placeholder="">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txt_pricebig" class="form-control" id="txt_pricebig" placeholder="">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="txt_fulltext" id="txt_fulltext" cols="45" rows="5"></textarea>
                    <script language="javascript">
