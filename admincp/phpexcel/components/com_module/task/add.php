...
Những mục đánh dấu <font color="red">*</font> là yêu cầu bắt buộc.
  <fieldset>
    ...
    <?php if($viewtype=="mainmenu" || $viewtype=="comments" || $viewtype=="latestnews" || $viewtype=="hotnews" || $viewtype=="html"){ ?>
    <fieldset>
    <legend><strong><?php echo "Parameter";?>:</strong></legend>
      ...
      <?php }else if($viewtype=="html"){?>
  	  <tr>
  	    <td colspan="2">
        <textarea name="txtcontent" id="txtcontent" cols="45" rows="7">&nbsp;</textarea>
		<script language="javascript">
