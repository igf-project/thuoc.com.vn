            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="info">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-3 form-control-label">Nhóm *</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="opt_active" type="radio" value="1" checked='true' />
                                <?php echo CYES;?>
                                <input name="opt_active" type="radio" value="0" />
                                <?php echo CNO;?>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="txt_name1" class="form-control" id="txt_name1" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tab2" id="tab2" cols="45" rows="5"></textarea>
                        <script language="javascript">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tab3" id="tab3" cols="45" rows="5"></textarea>
                        <script language="javascript">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tab4" id="tab4" cols="45" rows="5"></textarea>
                        <script language="javascript">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tab5" id="tab5" cols="45" rows="5"></textarea>
                        <script language="javascript">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="tab6" id="tab6" cols="45" rows="5"></textarea>
                        <script language="javascript">
