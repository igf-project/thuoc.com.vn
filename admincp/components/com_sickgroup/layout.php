<?php
	...
	define('COMS','sickgroup');
    define('OBJ','Nhóm bệnh');
...
<?php
	...
	if(isset($_POST['cmdsave'])){
		...
		$obj->Alias=un_unicode(addslashes($_POST['txt_name']));
		$obj->Content=addslashes($_POST['txt_fulltext']);
        $obj->Par_id=(int)$_POST['cbo_parent'];
        $obj->Specialist_id=(int)$_POST['cbo_group'];
		$obj->isActive=1;
