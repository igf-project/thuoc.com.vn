<?php
if($UserLogin->isAdmin(1) || $UserLogin->isAdmin(2)):
...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="list">
  <tr class="header">
	...
	<td align="center">Ngày Tham Gia</td>
	<td width="100" align="center">Kích hoạt</td>
	<td width="100" align="center">Xóa</td>
  </tr>
  <?php 
  ...
  while($rows=$obj->Fetch_Assoc()){
	...
	echo "<td align='center'>$cmt</td>";
	echo "<td align='center'>$cdate</td>";
	echo "<td align='center'>";
	echo "<a href='index.php?com=".COMS."&amp;task=active_account&amp;id=$username'>Kích Hoạt</a>";			
	echo "</td><td align='center'>";
	echo "<a href='index.php?com=".COMS."&amp;task=delete&amp;id=$username'>Xoá Tài khoản</a>";			
	echo "</td>";
	echo "</tr>";
  }
  ?>
