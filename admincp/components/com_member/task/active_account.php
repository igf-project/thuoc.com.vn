...
<form id="frm_action" name="frm_action" method="post" action="">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <td width="788">
		<input type='hidden' name='txt_kichhoat' id='txt_kichhoat' value='1'/>
      ...
      <tr>
        <td align="right" bgcolor="#EEEEEE"><strong>Số mã kích hoạt:</strong></td>
        <td>
			<input type='number' value='1' name='txt_number' id='txt_number' min="1"/>
			<input type="submit" name="cmdsave" id="cmdsave" value="Kích hoạt tài khoản" >
		</td>
      </tr>
    </table>
    </fieldset>
