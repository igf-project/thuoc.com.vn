        ...
        function checkinput(){
            if($("#txt_name").val()==""){
                $("#txt_name_err").fadeTo(200,0.1,function(){
                    $(this).html('Vui lòng nhập tên banner').fadeTo(900,1);
                });
                $("#txt_name").focus();
                return false;
            }
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline"><input type="radio" name="opt_isactive" value="1" checked>Có</label>
                                <label class="radio-inline"><input type="radio" name="opt_isactive" value="0">Không</label>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
