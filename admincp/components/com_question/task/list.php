...
define('OBJ_PAGE','QUESTION');
$key_category=$keyword='';
...
if($keyword!='')
    $strwhere.=" AND(`tbl_question`.`fullname` like '%$keyword%' OR `tbl_question`.`content` like '%$keyword%')";
if($key_category!='')
    $strwhere.=" AND `tbl_question`.`gquestion_id`='$key_category'";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Header_list">
            <tr>
                <td><strong><?php echo SEARCH;?>:</strong>
                    ...
                    <select name="key_category" id="key_category">
                        ...
                        <?php $obj_question_group->getListCbItem($key_category);?>
                    </select>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="table table-bordered">
                <tr class="header">
                    ...
                    <th>Tiêu đề</th>
                    <th>Nhóm câu hỏi</th>
                    <th width="30" align="center">New</th>
