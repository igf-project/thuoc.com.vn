...
define('OBJ_PAGE','MEDICAL_PROFILE');
...
if(isset($_POST['cbo_gblood']))
    $_SESSION['GBLOOD'.OBJ_PAGE]=addslashes($_POST['cbo_gblood']);
if(isset($_SESSION['KEY_'.OBJ_PAGE]))
    $keyword=$_SESSION['KEY_'.OBJ_PAGE];
else
    $keyword='';
$action=isset($_SESSION['ACT'.OBJ_PAGE]) ? $_SESSION['ACT'.OBJ_PAGE]:'';
$gblood=isset($_SESSION['GBLOOD'.OBJ_PAGE]) ? $_SESSION['GBLOOD'.OBJ_PAGE]:'';
...
if($gblood!='' && $gblood!='all' ){
    $strwhere.=" AND `gblood` = '$gblood'";
}
...
$cur_page=$_SESSION['CUR_PAGE_'.OBJ_PAGE] ? (int)$_SESSION['CUR_PAGE_'.OBJ_PAGE]:1;
// End pagging
?>
<div id="list">
    ...
    <form id="frm_list" name="frm_list" method="post" action="">
            ...
            <tr>
                <td>
                    ...
                    <!-- <select name="key_category" id="key_category" onchange="document.frm_list.submit();">
                        ...
                        <?php $obj_gdrug->getListCate(0,0); ?>
                    </select> -->
                    &nbsp&nbsp&nbsp&nbsp
                    <label>Nhóm máu:</label>
                    <select name="cbo_gblood" id="cbo_gblood" onchange="document.frm_list.submit();">
                        ...
                        <script language="javascript">
                            cbo_Selected('cbo_gblood','<?php echo $gblood;?>');
                        </script>
                    </select>
        ...
        <table class="table table-bordered">
          <tr class="header">
            ...
            <th>Số điện thoại</th>
            <th>Email</th>
            <th align="center">Người lập hs</th>
            <th align="center">Quan hệ</th>
            <!-- <th width="50" align="center">Hiển thị</th> -->
            <th width="50" align="center">Xem</th>
