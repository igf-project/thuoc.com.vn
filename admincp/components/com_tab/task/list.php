...
$info_drug = $obj_drug->getInfo(" AND drug_id=$drug_id");
// Get idtab
$strwhere=" WHERE 1=1 AND drug_id IN(".$drug_id.") ";
...
<div id="list">
    ...
    <form id="frm_list" name="frm_list" method="post" action="">
        <h1 style="font-size: 24px">Danh sách tab hướng dẫn <?php echo $info_drug['name'];?></h1>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3" class="table table-bordered">
            <tr class="header">
                ...
                <th align="center">Tên tab</th>
                <th align="center">Tên thuốc</th>
