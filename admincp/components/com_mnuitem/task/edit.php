					...
					<tr>
						...
						<td>
							<select name="cbo_cate" id="cbo_cate">
								...
								$objCate->getListCate($obj->Cat_ID,$obj->Cat_ID,0,1);
								?>
								<script language="javascript">
		...
		<table class="table table-bordered">
			<tr>
				...
				<td>
					...
					<input type="hidden" name="txtid" id="txtid" value="<?php echo $row['mnuitem_id'];?>">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input name="txtthumb" type="text" id="file-thumb" size="45" value="<?php echo $row['thumb'];?>" placeholder='' />
					<a href="#" onclick="OpenPopup('extensions/upload_image.php');"><b style="margin-top: 15px">Chọn</b></a>
				</td>
			</tr>
			<tr>
